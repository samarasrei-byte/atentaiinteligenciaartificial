...
const CESAR_ADMIN_ID = '6307fc12-d37c-43f5-ab78-c62cf29dffd9'; // Legacy - unused
...
export const EmbeddedFiscalChat: React.FC<EmbeddedFiscalChatProps> = ({ 
  ...
  const specialistId = GUILHERME_ADMIN_ID;
  const specialistName = 'Guilherme';
  const serviceName = 'Análise Fiscal';
  ...
  const createAutoRequest = async () => {
    ...
    try {
      ...
      const welcomeMessage = `${greeting} Guilherme! Sou o ${firstName}. Quero fazer uma análise fiscal aqui e vi que vocês identificam valores que posso recuperar. O que você precisa de mim pra começar?`;
