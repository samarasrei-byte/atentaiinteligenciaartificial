...
export const ChurnAnalytics: React.FC = () => {
  ...
  const fetchChurnData = async () => {
    ...
    try {
      ...
      // Simulated churn reasons (would need actual tracking)
      const churnReasons = [
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">Análise de Churn & Retenção</h2>
          <p className="text-muted-foreground">Métricas de cancelamento e retenção de usuários</p>
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Principais razões de churn (estimativas)</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
