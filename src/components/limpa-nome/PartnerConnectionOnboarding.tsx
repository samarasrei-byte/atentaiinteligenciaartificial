              ...
              {currentStep === 1 && (
                ...
                >
                  <div className="text-center">
                    <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-br from-primary/20 to-rose-500/20 flex items-center justify-center">
                  ...
                  <div className="space-y-3 py-4">
                    <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                      ...
                      <span className="text-sm text-muted-foreground">Análise feita por pessoas reais</span>
                    </div>
                    <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                      <Shield className="h-5 w-5 text-green-500" />
                      <span className="text-sm text-muted-foreground">Conexão com parceiro especializado</span>
                    </div>
                    <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                      <Heart className="h-5 w-5 text-rose-500" />
                      <span className="text-sm text-muted-foreground">Nada é automático – atendimento humano</span>
                    </div>
                  </div>

                  <Button 
                    onClick={nextStep}
                    className="w-full h-12 bg-gradient-to-r from-primary to-rose-500 hover:from-primary/90 hover:to-rose-500/90"
                  >
                    Iniciar conexão
                ...
                >
                  ...
                  <div className="space-y-3 py-4">
                    <div className="flex items-center gap-3 p-4 rounded-xl bg-green-500/10 border border-green-500/20">
                      ...
                      <span className="text-sm text-foreground">Conexão iniciada com sucesso</span>
                    </div>
                    <div className="flex items-center gap-3 p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                      <Users className="h-5 w-5 text-blue-500" />
                      <span className="text-sm text-foreground">Um parceiro humano irá analisar seu caso</span>
                    </div>
                    <div className="flex items-center gap-3 p-4 rounded-xl bg-primary/10 border border-primary/20">
                      <Handshake className="h-5 w-5 text-primary" />
                      <span className="text-sm text-foreground">Você está entrando em uma parceria séria e responsável</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-2 py-2">
                    ...
                    <span className="text-sm font-medium text-muted-foreground">Atendimento humano garantido</span>
                  </div>
