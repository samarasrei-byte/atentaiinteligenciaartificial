...
const aiServices: ServiceCardConfig[] = [
  ...
  },
  {
    ...
    targetAudience: 'Para quem quer conquistar um bem',
    features: ['Simulação em segundos', 'Comparativo vs banco', 'Análise por especialista'],
    guarantees: ['Sem juros abusivos', 'Análise gratuita'],
    basePrice: 0,
    discountPercent: 0,
    badge: 'new',
    cta: 'Simular agora',
  ...
  {
    key: 'recuperacao_energetica',
    name: 'Recuperação Fiscal Energética',
    description: 'Devolução de ICMS indevido na conta de luz. STF confirmado, retroativo até 10 anos.',
    targetAudience: 'PJ e PF com conta > R$150/mês',
    features: ['100% administrativo', 'Retroativo 10 anos', 'Sem risco jurídico'],
    guarantees: ['Decisão STF', 'Success fee'],
    basePrice: 0,
    discountPercent: 0,
    badge: 'new',
    cta: 'Simular recuperação',
    color: 'accent',
    icon: Zap,
    serviceType: 'recuperacao_energetica',
    checkoutRoute: '/recuperacao-energetica',
    category: 'empresarial',
    isFree: true,
    successFee: true,
  },
  {
    key: 'recuperacao_hidrica',
    name: 'Recuperação Fiscal Hídrica',
    description: 'Fator K — recuperação de valores indevidos na conta de água via mandado de segurança.',
    targetAudience: 'PJ com conta > R$2.000/mês',
    features: ['Mandado de segurança', 'Retroativo 5 anos', 'Especialista dedicado'],
    guarantees: ['Base jurídica sólida', 'Success fee'],
    basePrice: 0,
    discountPercent: 0,
    badge: 'new',
    cta: 'Simular recuperação',
    color: 'blue',
    icon: FileBarChart,
    serviceType: 'recuperacao_hidrica',
    checkoutRoute: '/recuperacao-hidrica',
    category: 'empresarial',
    isFree: true,
    successFee: true,
  },
  {
    ...
    description: 'Instale sem entrada. A própria economia na conta de luz paga o financiamento.',
    targetAudience: 'PJ e PF que quer economizar',
    features: ['Estudo gratuito', 'Sem investimento inicial', 'Economia integral após quitação'],
    guarantees: ['Zero investimento', 'Financiamento facilitado'],
    basePrice: 0,
    discountPercent: 0,
    badge: 'new',
    cta: 'Fazer estudo',
    color: 'emerald',
    icon: Sparkles,
    serviceType: 'placas_solares',
    checkoutRoute: '/placas-solares',
    category: 'empresarial',
    isFree: true,
  },
];
