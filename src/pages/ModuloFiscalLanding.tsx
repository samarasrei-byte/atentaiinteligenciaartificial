...
export default function ModuloFiscalLanding() {
      ...
      <section ref={heroRef} className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="container max-w-5xl mx-auto px-4 py-12 sm:py-16 relative z-10">
          ...
          >
            ...
            >
              Seu caso fiscal será analisado por um <span className="text-white font-medium">parceiro especializado</span>,
              com <span className="text-emerald-400 font-medium">acompanhamento real</span> e comunicação direta.
            </motion.p>
            ...
            <motion.div variants={itemVariants} className="flex justify-center mb-10 sm:mb-12 px-4">
              ...
              >
                ...
                Solicitar análise fiscal agora
        ...
        <div className="container max-w-5xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {benefits.map((benefit, i) => (
              ...
              >
                <Card className="h-full hover:border-emerald-500/50 transition-all duration-300">
                  <CardContent className="p-6 flex gap-4">
                    <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center flex-shrink-0 shadow-lg">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-6">
                Um parceiro real acompanhando seu caso
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                Diferente de sistemas automatizados, cada análise fiscal é feita por um 
                especialista humano que entende as particularidades do seu negócio.
              </p>
            ...
            >
              <Card className="w-full max-w-md border-2 border-emerald-500/20 bg-gradient-to-br from-emerald-500/5 to-green-500/5">
                <CardContent className="p-8">
                  <div className="flex items-center gap-4 mb-6">
                    <Avatar className="h-20 w-20 border-4 border-emerald-500/30">
                      <AvatarFallback className="bg-emerald-500/20 text-emerald-600 text-2xl font-bold">
                        GM
                      </AvatarFallback>
                    </Avatar>
                    <div>
                  ...
                  <div className="p-4 rounded-xl bg-muted/50 border border-border mb-6">
                    <p className="text-muted-foreground italic">
                      "Olá! Sou especialista em recuperação fiscal. Vou analisar pessoalmente 
                      as oportunidades da sua empresa e acompanhar todo o processo. Conte comigo!"
                    </p>
                  </div>
        ...
        <div className="container max-w-3xl mx-auto px-4 text-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
              Pronto para otimizar seus impostos?
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              Conecte-se agora com um especialista e descubra quanto sua empresa pode recuperar.
            </p>
            <Button 
              size="lg"
              onClick={() => navigate('/bi-contabilidade/onboarding')}
              className="h-16 px-12 text-lg bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600"
            >
              <Users className="h-5 w-5 mr-2" />
              Solicitar análise fiscal agora
              <ArrowRight className="h-5 w-5 ml-2" />
