      ...
      <div className="min-h-screen bg-slate-950 text-slate-200 overflow-x-hidden font-sans">
        ...
        <ParallaxSection id="proposta-comercial" className="bg-slate-900/50 border-t border-white/[0.03]" speed={0.3}>
          ...
          <motion.div variants={fadeUp} className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-6xl font-black text-white mt-3">
              Investimento <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">Estratégico</span>
            </h2>
            <p className="text-slate-500 text-lg mt-4 max-w-3xl mx-auto">
              Setup de implantação + planos mensais modulares para cada startup do ecossistema
            </p>
          </motion.div>

          {/* Setup de Implantação */}
          <motion.div variants={fadeUp} className="max-w-3xl mx-auto mb-14">
            <GlassCard accent glow className="p-10 relative overflow-hidden text-center">
              <div className="absolute top-0 left-0 w-80 h-80 bg-amber-500/5 rounded-full blur-[100px]" />
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl md:text-3xl font-black text-white mb-2">Implantação do Ecossistema</h3>
                <p className="text-slate-400 max-w-xl mx-auto mb-6">
                  Configuração completa da plataforma White Label, campanhas de prospecção e agentes de IA — tudo implantado e operando sob a marca SERAC
                </p>
                <span className="text-5xl md:text-6xl font-black bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 bg-clip-text text-transparent">R$ 50.000</span>
                <p className="text-slate-500 text-sm mt-2">Valor único de implantação</p>

                <div className="flex flex-wrap items-center justify-center gap-3 mt-6">
                  <span className="inline-flex items-center gap-1.5 text-cyan-400 bg-cyan-500/10 border border-cyan-500/20 text-xs font-bold px-3 py-1.5 rounded-full">
                    <Brain className="w-3 h-3" /> AtentAI White Label
                  </span>
                  <span className="inline-flex items-center gap-1.5 text-violet-400 bg-violet-500/10 border border-violet-500/20 text-xs font-bold px-3 py-1.5 rounded-full">
                    <Target className="w-3 h-3" /> G8 Prospect
                  </span>
                  <span className="inline-flex items-center gap-1.5 text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 text-xs font-bold px-3 py-1.5 rounded-full">
          ...
          {/* Planos Mensais Separados */}
          <motion.div variants={fadeUp} className="text-center mb-8">
            <h3 className="text-2xl font-black text-white">Planos Mensais</h3>
            <p className="text-slate-500 text-sm mt-2">Após a implantação, cada solução opera com seu plano mensal</p>
          </motion.div>
